...
var statsic = new Vue({
    ...
    methods:{
        ...
        getStatistics: function(e){
            axios.post(url+'common/get_common_count').then(function(e){     
...
function signup_submit(){
    var arr = [
        ...
        {id: 'sudesig',validate: {required: 1,email: 0,mobile: 0},msg:'Designation'},
    ...
    methods:{
        change_password: function(e){
            ...
            var arr = [
                ...
                {id: 'resetconfirm',validate: {required: 1,email: 0,mobile: 0},msg:'Designation'},
            ]
            var v = smart_validate(arr);
