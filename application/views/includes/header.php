...
<body>
  ...
  <header id="nav-head" style="background-color: #b0e0e6;">
  	<div class="container">
  		<div class="row">
  			<div class="col-lg-3 col-md-3 d-lokj">
  				<a href="<?php echo base_url() ?>">
  				<img src="<?php echo base_url() ?>upload/admin/logo.png?<?php echo date("Ymd");?>" alt="Atom Forum">
  				</a>
  			...
  			<div id="login" class="col-lg-4 col-md-5 d-none d-md-block center login-btns">
				...
				<li>	<div class="dropdown forum-dd">
