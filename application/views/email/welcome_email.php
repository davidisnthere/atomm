			...
			<table  class="table-content">
				...
				<tr>
					<td class="welcome-message">
						<p>We’re excited to have you get started. First, you need to confirm your account. Just press the button below
						</p>				
					</td>
				</tr>
				<tr>
					<td class="link-button">
						<a class="libnk-btna" href="<?php echo $activation_link ?>">
							<div class="libnk-btn">Confirm Account</div>
						</a>
