				...
				<div class="setting-card">
					...
					<div class="tab-content" id="myTabContent">
						<div  class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="row no-margin form-row">
								<div class="col-sm-4"><label for="">Designation</label><span class="rit-coln">:</span></div>
								<div class="col-sm-8"><input value="<?php echo $this->single->designation ?>" id="usdesig" type="text" placeholder="Enter Designation" class="form-control form-control-sm">
									<div id="loemail-err" class="smart-valid"></div>
								</div>
							</div>
							<div class="row no-margin form-row">
